...
public class Triangle
{
    ...
    /**
     * Indicator to know if the triangle is a border triangle of the triangulation framework
     */
     ...
     * 
     * @param id ID of the triangle
     * @param border defines if the triangle is a border triangle or not in the triangulation
     *            framework
     */
    ...
    /**
     * Returns true if the triangle is a border triangle of the triangulation framework, false
     * otherwise.
     * 
    ...
    /**
     * Defines the indicator to know if the triangle is a border triangle of the triangulation
     * framework.
     * 
     ...
     * @return true if added, false otherwise
     */
    public boolean addEdges(List<Edge> e)
    {
        return getEdges().addAll(e);
    }
     ...
     * @return true if removed, false otherwise
     */
    public boolean removeEdges(List<Edge> e)
    {
        return getEdges().removeAll(e);
    }
