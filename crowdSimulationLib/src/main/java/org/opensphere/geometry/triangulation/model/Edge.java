...
public class Edge
{
     ...
     *
     * @param id ID of the edge
     * @param border defines if the edge is a border edge or not in the triangulation framework
     */
     ...
     * @return true if added, false otherwise
     */
    public boolean addTriangles(List<Triangle> t)
    {
        return getTriangles().addAll(t);
    }
     ...
     * @return true if removed, false otherwise
     */
    public boolean removeTriangles(List<Triangle> t)
    {
        return getTriangles().removeAll(t);
    }
