/*
 * This file is part of the OpenSphere project which aims to develop geospatial algorithms.
 *
 ...
 * 02111-1307 USA
 *
 * For more information, contact: Eric Grosso, eric.grosso.os@gmail.com
 *
 */
...
/**
 * Computes a concave hull of a {@link Geometry} which is a concave {@link Geometry} that contains
 * all the points in the input {@link Geometry}. The concave hull is not be defined as unique; here,
 * it is defined according to a threshold which is the maximum length of border edges of the concave
 * hull.
 *
 * <p>
...
public class ConcaveHull
{
    ...
    /**
     * Transforms a given {@link GeometryCollection} into a new {@link GeometryCollection} that
     * consists only unique {@link Point} objects
     *
     * @param gc input {@link GeometryCollection} object
     * @return a geometry collection
     */
    ...
    /**
     * Returns a {@link Geometry} that represents the concave hull of the input geometry according
     * to the threshold. The returned geometry contains the minimal number of points needed to
     * represent the concave hull.
     *
     * @return if the concave hull contains 3 or more points, a {@link Polygon}; 2 points, a
     *         {@link LineString}; 1 point, a {@link Point}; 0 points, an empty
    ...
    private Geometry concaveHull()
    {
        ...
        Collection<org.locationtech.jts.triangulate.quadedge.Vertex> qeVertices = qes
            .getVertices(false);
        ...
        int index = 0;
        while (index != -1 && !Thread.currentThread().isInterrupted())
        {
            index = -1;
        ...
        List<LineString> tempEdges = new ArrayList<>();
